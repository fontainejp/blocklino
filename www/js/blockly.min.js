...
Blockly.Comment.prototype.dispose=function(){Blockly.Events.isEnabled()&&this.setText("");this.block_.comment=null;this.block_.coder=null;Blockly.Icon.prototype.dispose.call(this)};
...
Blockly.Xml.blockToDom=function(a,b){var c=goog.dom.createDom(a.isShadow()?"shadow":"block");c.setAttribute("type",a.type);b||c.setAttribute("id",a.id);if(a.mutationToDom){var d=a.mutationToDom();d&&(d.hasChildNodes()||d.hasAttributes())&&c.appendChild(d)}for(var d=0,e;e=a.inputList[d];d++)for(var f=0,g;g=e.fieldRow[f];f++)if(g.name&&g.EDITABLE){var h=goog.dom.createDom("field",null,g.getValue());h.setAttribute("name",g.name);c.appendChild(h)}
			if (d = a.getCoderText()) d = goog.dom.createDom("coder",
        null, d), "object" == typeof a.coder && (d.setAttribute("pinned", a.coder.isVisible()), e = a.coder.getBubbleSize(), d.setAttribute("h", e.height), d.setAttribute("w", e.width)), c.appendChild(d);if(d=a.getCommentText())d=goog.dom.createDom("comment",
...
Blockly.ZoomControls=function(a){this.workspace_=a};Blockly.ZoomControls.prototype.WIDTH_=32;Blockly.ZoomControls.prototype.HEIGHT_=100;Blockly.ZoomControls.prototype.MARGIN_BOTTOM_=12;Blockly.ZoomControls.prototype.MARGIN_SIDE_=12;Blockly.ZoomControls.prototype.svgGroup_=null;Blockly.ZoomControls.prototype.left_=0;Blockly.ZoomControls.prototype.top_=0;
...
Blockly.Warning.prototype.dispose=function(){this.block_.warning=null;Blockly.Icon.prototype.dispose.call(this)};Blockly.Block=function(a,b,c){this.id=c&&!a.getBlockById(c)?c:Blockly.genUid();a.blockDB_[this.id]=this;this.previousConnection=this.nextConnection=this.outputConnection=null;this.inputList=[];this.inputsInline=void 0;this.disabled=!1;this.tooltip="";this.contextMenu=!0;this.parentBlock_=null;this.childBlocks_=[];this.editable_=this.movable_=this.deletable_=!0;this.collapsed_=this.isShadow_=!1;this.comment=null;this.coder=null;this.xy_=new goog.math.Coordinate(0,0);this.workspace=a;this.isInFlyout=a.isFlyout;this.isInMutator=
...
Blockly.Block.prototype.setCommentText=function(a){this.comment!=a&&(Blockly.Events.fire(new Blockly.Events.Change(this,"comment",null,this.comment,a||"")),this.comment=a)};
Blockly.Block.prototype.setWarningText=function(a){};Blockly.Block.prototype.setMutator=function(a){};
...
Blockly.BlockSvg.prototype.unselect=function(){if(Blockly.selected==this){var a=new Blockly.Events.Ui(null,"selected",this.id,null);a.workspaceId=this.workspace.id;Blockly.Events.fire(a);Blockly.selected=null;this.removeSelect()}};Blockly.BlockSvg.prototype.mutator=null;Blockly.BlockSvg.prototype.comment=null;Blockly.BlockSvg.prototype.coder=null;Blockly.BlockSvg.prototype.warning=null;
Blockly.BlockSvg.prototype.getIcons=function(){var a=[];this.mutator&&a.push(this.mutator);this.comment&&a.push(this.comment);this.coder&&a.push(this.coder);this.warning&&a.push(this.warning);return a};
Blockly.BlockSvg.onMouseUpWrapper_=null;Blockly.BlockSvg.onMouseMoveWrapper_=null;
...
"display: block;","}",".blocklyIconGroup {","cursor: default;","}",".blocklyIconGroup:not(:hover),",".blocklyIconGroupReadonly {","opacity: .6;","}",".blocklyIconShape {","fill: #00f;","stroke: #fff;","stroke-width: 1px;","}",".blocklyCode {","fill: #f00;","stroke: #f00;","stroke-width: 1px;","}",".blocklyIconSymbol {","fill: #fff;","}",".blocklyMinimalBody {","margin: 0;","padding: 0;","}",".blocklyCommentTextarea {","background-color: #ffc;","border: 0;","margin: 0;","padding: 2px;","resize: none;","}",".blocklyHtmlInput {","border: none;","border-radius: 4px;","font-family: sans-serif;",
...
Blockly.isRightButton=function(a){return a.ctrlKey&&goog.userAgent.MAC?!0:2==a.button};Blockly.mouseToSvg=function(a,b,c){var d=b.createSVGPoint();d.x=a.clientX;d.y=a.clientY;c||(c=b.getScreenCTM().inverse());return d.matrixTransform(c)};
...
Blockly.prompt=function(a,b,c){c(ipcRenderer.sendSync("modalVar", a))};
...
//
Blockly.coder = function(a) {
    Blockly.coder.superClass_.constructor.call(this, a);
    this.createIcon()
};
goog.inherits(Blockly.coder, Blockly.Icon);
Blockly.coder.prototype.text_ = "";
Blockly.coder.prototype.width_ = 160;
Blockly.coder.prototype.height_ = 80;
Blockly.coder.prototype.drawIcon_ = function(a) {
    ...
    Blockly.createSvgElement("line", {
		"stroke": "#FFFFFF", "stroke-width":"1.5", x1:2, x2:7, y1:9, y2:4
	}, a);
    Blockly.createSvgElement("line", {
		"stroke": "#FFFFFF", "stroke-width":"1.5", x1:2, x2:7, y1:9, y2:14
	}, a);
    Blockly.createSvgElement("line", {
		"stroke": "#FFFFFF", "stroke-width":"1.5", x1:12, x2:17, y1:4, y2:9
	}, a);
    Blockly.createSvgElement("line", {
		"stroke": "#FFFFFF", "stroke-width":"1.5", x1:17, x2:12, y1:9, y2:14
	}, a);
    Blockly.createSvgElement("line", {
		"stroke": "#FFFFFF", "stroke-width":"1.5", x1:10, x2:9, y1:2, y2:16
	}, a);
};
Blockly.coder.prototype.createEditor_ = function() {
    ...
    b.className = "blocklycoderTextarea";
    ...
    Blockly.bindEventWithChecks_(b, "change", this, function(a) {
        this.text_ != b.value && (Blockly.Events.fire(new Blockly.Events.Change(this.block_, "coder", null, this.text_, b.value)), this.text_ = b.value)
    });
    setTimeout(function() {
        b.focus()
    }, 0);
...
Blockly.coder.prototype.updateEditable = function() {
    this.isVisible() && (this.setVisible(!1), this.setVisible(!0));
    Blockly.Icon.prototype.updateEditable.call(this)
};
Blockly.coder.prototype.resizeBubble_ = function() {
    if (this.isVisible()) {
...
Blockly.coder.prototype.setVisible = function(a) {
    if (a != this.isVisible())
        if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "coderOpen", !a, a)), !this.block_.isEditable() && !this.textarea_ || goog.userAgent.IE) Blockly.Warning.prototype.setVisible.call(this, a);
        else {
            var b = this.getText(),
...
Blockly.coder.prototype.textareaFocus_ = function(a) {
    this.bubble_.promote_();
    this.textarea_.focus()
};
Blockly.coder.prototype.getBubbleSize = function() {
    return this.isVisible() ? this.bubble_.getBubbleSize() : {
        width: this.width_,
        height: this.height_
    }
};
Blockly.coder.prototype.setBubbleSize = function(a, b) {
    this.textarea_ ? this.bubble_.setBubbleSize(a, b) : (this.width_ = a, this.height_ = b)
};
Blockly.coder.prototype.getText = function() {
    return this.textarea_ ? this.textarea_.value : this.text_
};
Blockly.coder.prototype.setText = function(a) {
    this.text_ != a && (Blockly.Events.fire(new Blockly.Events.Change(this.block_, "coder", null, this.text_, a)), this.text_ = a);
    this.textarea_ && (this.textarea_.value = a)
};
Blockly.coder.prototype.dispose = function() {
    Blockly.Events.isEnabled() && this.setText("");
    this.block_.coder = null;
    Blockly.Icon.prototype.dispose.call(this)
};
Blockly.Block.prototype.getCoderText=function(){
	return this.coder||""
};
Blockly.Block.prototype.setCoderText=function(a){
	this.coder!=a&&(Blockly.Events.fire(new Blockly.Events.Change(this,"coder",null,this.coder,a||"")),this.coder=a)
};
Blockly.Generator.prototype.allNestedCodes=function(a){
	var b=[];
	a=a.getDescendants();
	for(var c=0;c<a.length;c++){
		var d=a[c].getCoderText();
		d&&b.push(d)
	}
	b.length&&b.push("");
	return b.join("\n")
};
Blockly.BlockSvg.prototype.getCoderText = function() {
    return this.coder ? this.coder.getText().replace(/\s+$/, "").replace(/ +\n/g, "\n") : ""
};
Blockly.BlockSvg.prototype.setCoderText = function(a) {
    var b = !1;
    goog.isString(a) ? (this.coder || (this.coder = new Blockly.coder(this), b = !0), this.coder.setText(a)) : this.coder && (this.coder.dispose(), b = !0);
