...
Blockly.Blocks["controls_flow_statements"] = {
    ...
    onchange: function() {
        ...
        var block = this;
        do {
            if (block.type == "controls_repeat" || block.type == "controls_repeat_ext" || block.type == "controls_forEach" || block.type == "controls_for" || block.type == "controls_whileUntil") {
                legal = true;
                break
            }
...
Blockly.Blocks["procedures_defreturn"] = {
    init: function() {
		...
		this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.PROCEDURES_MUTATORARG_TYPE)
			.appendField(new Blockly.FieldDropdown(Blockly.Types.getValidTypeArray()), "type")
        this.setMutator(new Blockly.Mutator(["procedures_mutatorarg"]));
        this.setColour(Blockly.Blocks.procedures.HUE);
