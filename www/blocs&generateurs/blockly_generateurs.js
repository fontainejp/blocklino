...
// tableau
Blockly.Arduino['creer_liste']=function(block){
    var etat_var = Blockly.Arduino.variableDB_.getName(block.getFieldValue('VAR'), Blockly.Variables.NAME_TYPE);
	var code = Blockly.Arduino.valueToCode(block, "list", Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.variables_[etat_var] = 'enum ' + code + ' '+etat_var+';';
    return '';
};
