...
Blockly.Blocks['rvb_set']={init:function() {
    this.appendDummyInput()
        .appendField("afficher la couleur");
...
Blockly.Blocks["moteur_dc"]={init:function(){
		...
		.appendField(Blockly.Msg.moteur).appendField(new Blockly.FieldDropdown([[Blockly.Msg.right,"6"],[Blockly.Msg.left,"5"]]), "MOTEUR");
...
Blockly.Python["moteur_dc"]=function(block){
    var dropdown_moteur=block.getFieldValue("MOTEUR");
    var dropdown_mot=parseInt(dropdown_moteur) + 5;
    var dropdown_etat=block.getFieldValue("ETAT");
    var value_vitesse=Blockly.Python.valueToCode(block, "Vitesse");
    Blockly.Python.setups_["setup_output_" + dropdown_moteur]="pinMode(" + dropdown_moteur + ", OUTPUT);";
    Blockly.Python.setups_["setup_output_" + dropdown_mot]="pinMode(" + dropdown_mot + ", OUTPUT);";
    return "analogWrite(" + dropdown_moteur + "," + value_vitesse + ");\ndigitalWrite(" + dropdown_mot + "," + dropdown_etat + ");\n"
};
//////////////
Blockly.Blocks["moteur_dc_stop"]={init:function(){
        this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 75, 50))
		.appendField(Blockly.Msg.moteurstop).appendField(new Blockly.FieldDropdown([[Blockly.Msg.right,"6"],[Blockly.Msg.left,"5"]]), "MOTEUR");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour("#00929F");
...
Blockly.Python["moteur_dc_stop"]=function(block){
    var dropdown_moteur=block.getFieldValue("MOTEUR");
    var dropdown_mot=parseInt(dropdown_moteur) + 5;
    Blockly.Python.setups_["setup_output_" + dropdown_moteur]="pinMode(" + dropdown_moteur + ", OUTPUT);";
    Blockly.Python.setups_["setup_output_" + dropdown_mot]="pinMode(" + dropdown_mot + ", OUTPUT);";
...
Blockly.Python["dcmotor_v1"]=function(block){
    var dropdown_moteur=block.getFieldValue("MOTEUR");
    var dropdown_etat=block.getFieldValue("ETAT");
    var value_vitesse=Blockly.Python.valueToCode(block, "Vitesse");
    Blockly.Python.includes_["AFMotor.h"]="#include <AFMotor.h>";
    Blockly.Python.definitions_["AF_DCMotor" + dropdown_moteur]="AF_DCMotor motor_dc_" + dropdown_moteur + "(" + dropdown_moteur + ", MOTOR12_2KHZ);";
    return "motor_dc_" + dropdown_moteur + ".setSpeed(" + value_vitesse + ");\nmotor_dc_" + dropdown_moteur + ".run(" + dropdown_etat + ");\n"
};
//////////////
...
Blockly.Python["moteur_action"]=function(block){
    ...
    var value_speed=block.getFieldValue("speed");
    Blockly.Python.includes_["AFMotor.h"]="#include <AFMotor.h>";
    Blockly.Python.definitions_["AF_DCMotor_1"]="AF_DCMotor motor_dc_1(1, MOTOR12_2KHZ);";
    Blockly.Python.definitions_["AF_DCMotor_2"]="AF_DCMotor motor_dc_2(2, MOTOR12_2KHZ);";
    switch (dropdown_menu) {
        case "a":
            var code="motor_dc_1.setSpeed(2*" + value_speed + ");\nmotor_dc_1.run(FORWARD);\nmotor_dc_2.setSpeed(2*" + value_speed + ");\nmotor_dc_2.run(FORWARD);\n";
            break;
...
Blockly.Python["dagu_rs027"]=function(block){
    var dropdown_moteur=block.getFieldValue("MOTEUR");
    var dropdown_mot=parseInt(dropdown_moteur) - 2;
    var dropdown_etat=block.getFieldValue("ETAT");
    var value_vitesse=Blockly.Python.valueToCode(block, "Vitesse");
...
Blockly.Python["moteur3v"]=function(block){
    var dropdown_pin=block.getFieldValue("pin");
    var value_num=Blockly.Python.valueToCode(block, "speed", Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python["m_pap"]=function(block){
    ...
    Blockly.Python.includes_["stepper"]="#include <Stepper.h>";
...
Blockly.Blocks["matrice_symbole"]={init:function(){
	var inputL1 = new Blockly.FieldTextInput("0101010101010101");
	inputL1.maxDisplayLength = 18;
    this.appendDummyInput()
		.appendField(Blockly.Msg.matrice16x8_symbole)
		.appendField(new Blockly.FieldVariable(Blockly.Msg.VARIABLES_GET_ITEM), "VAR")
		.appendField(new Blockly.FieldDropdown([["16x8","16"],["8x8","8"]]), "matrix");
	this.appendDummyInput("m161").setAlign(Blockly.ALIGN_RIGHT).appendField(inputL1, "L1");
    this.appendDummyInput("m162").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldTextInput("1010101010101010"), "L2");
    this.appendDummyInput("m163").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldTextInput("0101010101010101"), "L3");
    this.appendDummyInput("m164").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldTextInput("1010101010101010"), "L4");
    this.appendDummyInput("m165").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldTextInput("0101010101010101"), "L5");
    this.appendDummyInput("m166").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldTextInput("1010101010101010"), "L6");
    this.appendDummyInput("m167").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldTextInput("0101010101010101"), "L7");
    this.appendDummyInput("m168").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldTextInput("1010101010101010"), "L8");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks["matrice_init"]={init:function(){
    this.appendDummyInput().appendField(Blockly.Msg.matrice)
		.appendField(new Blockly.FieldDropdown([["16x8","16"],["8x8","8"]],function(option){this.sourceBlock_.updateShape(option)}), "matrix");
