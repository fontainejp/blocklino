...
Blockly.Arduino["lp2i_mp3_init"]=function(block){
    ...
    if (autoplay){
		Blockly.Arduino.setups_["mp3"]="module.mp3_auto_play("+ volume_hex +");";
...
Blockly.Blocks["servo_rot_continue_param"]={init:function(){
        ...
        this.appendValueInput("PIN").setAlign(Blockly.ALIGN_RIGHT).setCheck("Number").appendField(Blockly.Msg.pin);
        this.setInputsInline(false);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour("#00929F");
...
Blockly.Arduino["matrice_init"]=function(block){
	...
	switch (type_matrix) {
        case "16":
			Blockly.Arduino.definitions_["mat16"]="Matrice16 module;";
			Blockly.Arduino.setups_["matrice16init"]="module.initialisation();";
		...
		case "8":
			...
			var clk=Blockly.Arduino.valueToCode(block, "CLK", Blockly.Arduino.ORDER_ASSIGNMENT);
			var cs=Blockly.Arduino.valueToCode(block, "CS", Blockly.Arduino.ORDER_ASSIGNMENT);
			Blockly.Arduino.includes_["ledcontrol"]='#include <LedControl.h>';
			Blockly.Arduino.definitions_["ledcontrol"]="LedControl lc=LedControl(" + din + "," + clk + "," + cs + ",1);";
			Blockly.Arduino.definitions_["mat8"]="Matrice8 module;";
			Blockly.Arduino.setups_["matrice8init"]="module.initialisation();";
		...
		case "32":
			...
			var cs=Blockly.Arduino.valueToCode(block, "CS", Blockly.Arduino.ORDER_ASSIGNMENT);
			Blockly.Arduino.includes_["ledcontrol"]='#include <LedControl.h>';
			Blockly.Arduino.definitions_["ledcontrol"]="LedControl lc=LedControl(" + din + "," + clk + "," + cs + ",4);";
			Blockly.Arduino.definitions_["mat32"]="Matrice32 module;";
			Blockly.Arduino.setups_["matrice32init"]="module.initialisation();";
			break;
	}
	return ""
};
