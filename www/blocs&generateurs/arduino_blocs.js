...
Blockly.Blocks["bluetooth_b"]={init:function(){
        this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 14, 24))
			.appendField("Bluetooth sur carte dagu").appendField(new Blockly.FieldCheckbox("FALSE"), "dagu");
        this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField("vitesse").appendField(new Blockly.FieldDropdown(profile.defaultBoard.serial), "SPEED");
...
Blockly.Blocks["esp8266_init"]={init:function(){
	...
	this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.esp8266_10).appendField(new Blockly.FieldDropdown(Blockly.Msg.esp8266_9,function(option){this.sourceBlock_.updateShape1_(option)}), "staticdynamic")
...
Blockly.Blocks["esp8266_create_item"]={init:function(){
    this.setColour("#000000");
    this.appendDummyInput().appendField("on trouve");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(".");
    this.contextMenu = false}
...
Blockly.Blocks["esp8266_create_container"]={init:function(){
        this.setColour("#000000");
        this.appendDummyInput().appendField("si dans la requête on trouve");
        this.appendStatementInput("STACK");
        this.setTooltip(".");
        this.contextMenu = false
    }
