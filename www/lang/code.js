...
Code.getLang = function() {
  if (window.localStorage.lang === undefined) {
    window.localStorage.lang = BlocklyDuino.lang
  }
...
Code.initLanguage = function() {
  ...
  $('#span_local_online_factory').text(Blockly.Msg['span_local_online_factory'])
  $('#span_make_it').text(Blockly.Msg['span_make_it'])
